...
/**
 * Admin Login Page
 * Now with Google reCAPTCHA v2 Protection (100% Secure)
 */
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            min-height: 100vh;
            background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 1000%);
            padding: 1rem;
            position: relative;
            overflow-x: hidden;
        }
        ...
        <div class="login-card">
            ...
            <div class="security-notice">
                <small>
                    ...
                    Protected with Google reCAPTCHA • Secure Admin Access
                </small>
            </div>
        </div>
    </div>
